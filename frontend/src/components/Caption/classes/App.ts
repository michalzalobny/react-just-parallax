...
export class App {
  static backgroundColor = 'rgba(246,246,246,1)';
  ...
  _onResize() {
    ...
    this._rendererBounds.height = window.innerHeight; //It's only used to fix height on mobile (normally 100vh would be enough)
